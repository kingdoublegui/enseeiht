 ...
 */
public class Allocateur_Petits_Chaine implements Allocateur {
    ...
    public Allocateur_Petits_Chaine (int nbRessources)
    {
    ...
    private void libererPetits() {
        for (int iDemande = 1; iDemande <= nbRessources; iDemande++) {
            if (iDemande <= nbLibres && tailleClasse[iDemande] > 0) {
