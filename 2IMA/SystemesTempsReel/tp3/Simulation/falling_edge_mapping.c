...
void _SCSIM_Mapping_Create() {
	_SCSIM_Mapping_falling_edge();
	pSimulator->m_pfnFinalizeMapping(pSimulator);
}

/****************************************************************
 ** falling_edge/ mapping function
 ****************************************************************/
void _SCSIM_Mapping_falling_edge() {
	pSimulator->m_pfnSetRoot(pSimulator, "falling_edge/", &outputs_ctx, _SCSIM_Get_falling_edge_Handle);
	pSimulator->m_pfnAddLocal(pSimulator, "_L8", &_SCSIM_kcg_bool_Utils, 1, valid, 0, 0);
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L4", &_SCSIM_kcg_bool_Utils, 5, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L5", &_SCSIM_kcg_bool_Utils, 6, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L6", &_SCSIM_kcg_bool_Utils, 7, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L7", &_SCSIM_kcg_bool_Utils, 8, valid, 0, 0);
	pSimulator->m_pfnAddOutput(pSimulator, "Y", &_SCSIM_kcg_bool_Utils, 9, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "X", &_SCSIM_kcg_bool_Utils, 10, valid, 0, 0);
}
