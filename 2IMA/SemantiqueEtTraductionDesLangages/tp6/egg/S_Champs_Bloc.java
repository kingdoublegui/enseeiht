...
if  (att_eval)	  action_champs_51();
  ...
  private void regle50() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_50(x_2, x_3);
	x_2.analyser() ;
	x_3.analyser() ;
if  (att_eval)	  action_champs_50(x_2, x_3);
  }
private void action_champs_51() throws Exception {
try {
// instructions
...
private void action_champs_50(S_Champ_Bloc x_2, S_Champs_Bloc x_3) throws Exception {
try {
// locales
...
private void action_auto_inh_50(S_Champ_Bloc x_2, S_Champs_Bloc x_3) throws Exception {
try {
// instructions
