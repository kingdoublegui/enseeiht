...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#ast_syn","SuiteFacteur -> Multiplicatif Facteur #ast_inh SuiteFacteur1 #ast_syn ;"});
}
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#ast_inh","SuiteFacteur -> Multiplicatif Facteur #ast_inh SuiteFacteur1 #ast_syn ;"});
}
  }
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#ast","SuiteFacteur -> #ast ;"});
}
  }
  public void analyser () throws Exception {
    scanner.lit ( 1 ) ;
    switch ( scanner.fenetre[0].code ) {
      case LEX_Bloc.token_multiplication : // 37
        regle23 () ;
      break ;
      case LEX_Bloc.token_addition : // 34
        regle24 () ;
      break ;
      case LEX_Bloc.token_egalite : // 33
        regle24 () ;
      break ;
      case LEX_Bloc.token_point_virgule : // 30
        regle24 () ;
      break ;
      case LEX_Bloc.token_parenthese_fermante : // 24
        regle24 () ;
      break ;
      case LEX_Bloc.token_virgule : // 31
        regle24 () ;
      break ;
      case LEX_Bloc.token_superieur : // 26
        regle24 () ;
      break ;
      default :
