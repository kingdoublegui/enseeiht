...
int [] sync= new int[0];
  ...
  private void regle10() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_10(x_4, x_6, x_7);
	...
	x_6.analyser() ;
	x_7.analyser() ;
if  (att_eval)	  action_ast_10(x_4, x_6, x_7);
  }
...
if  (att_eval)	  action_inh_9(x_2, x_5);
	x_5.analyser() ;
	x_6.analyser(LEX_Bloc.token_point_virgule);
if  (att_eval)	  action_ast_9(x_2, x_5);
  }
...
private void action_inh_7(S_Type_Bloc x_2, T_Bloc x_3, S_Expression_Bloc x_6) throws Exception {
try {
// locales
Declaration loc_d;
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#inh","Instruction -> Type identificateur affectation #inh Expression point_virgule #ast ;"});
}
  }
private void action_auto_inh_8(S_Type_Bloc x_3, T_Bloc x_4, S_Valeur_Bloc x_7) throws Exception {
try {
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#auto_inh","Instruction -> constante Type identificateur affectation #inh Valeur point_virgule #ast ;"});
}
  }
private void action_auto_inh_9(T_Bloc x_2, S_Expression_Bloc x_5) throws Exception {
try {
// instructions
x_5.att_factory=this.att_factory;
x_5.att_tds=this.att_tds;
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#auto_inh","Instruction -> identificateur affectation #inh Expression point_virgule #ast ;"});
}
  }
private void action_auto_inh_7(S_Type_Bloc x_2, T_Bloc x_3, S_Expression_Bloc x_6) throws Exception {
try {
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#auto_inh","Instruction -> Type identificateur affectation #inh Expression point_virgule #ast ;"});
}
  }
private void action_inh_9(T_Bloc x_2, S_Expression_Bloc x_5) throws Exception {
try {
// locales
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#inh","Instruction -> identificateur affectation #inh Expression point_virgule #ast ;"});
}
  }
private void action_inh_8(S_Type_Bloc x_3, T_Bloc x_4, S_Valeur_Bloc x_7) throws Exception {
try {
// locales
Declaration loc_d;
// instructions
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#inh","Instruction -> constante Type identificateur affectation #inh Valeur point_virgule #ast ;"});
}
  }
private void action_ast_10(S_Expression_Bloc x_4, S_Bloc_Bloc x_6, S_SuiteConditionnelle_Bloc x_7) throws Exception {
try {
// instructions
...
private void action_ast_9(T_Bloc x_2, S_Expression_Bloc x_5) throws Exception {
try {
// locales
Optional<Declaration> loc_opd;
Declaration loc_d;
...
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#ast","Instruction -> identificateur affectation #inh Expression point_virgule #ast ;"});
}
  }
...
private void action_auto_inh_10(S_Expression_Bloc x_4, S_Bloc_Bloc x_6, S_SuiteConditionnelle_Bloc x_7) throws Exception {
try {
// instructions
...
private void action_ast_7(S_Type_Bloc x_2, T_Bloc x_3, S_Expression_Bloc x_6) throws Exception {
try {
// instructions
this.att_ast=this.att_factory.createVariableDeclaration(x_3.att_txt, x_2.att_ast, x_6.att_ast);
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#ast","Instruction -> Type identificateur affectation #inh Expression point_virgule #ast ;"});
}
  }
...
private void action_ast_8(S_Type_Bloc x_3, T_Bloc x_4, S_Valeur_Bloc x_7) throws Exception {
try {
// instructions
this.att_ast=this.att_factory.createConstantDeclaration(x_4.att_txt, x_3.att_ast, x_7.att_ast);
}catch(RuntimeException e) {	   att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "Bloc", "#ast","Instruction -> constante Type identificateur affectation #inh Valeur point_virgule #ast ;"});
}
  }
