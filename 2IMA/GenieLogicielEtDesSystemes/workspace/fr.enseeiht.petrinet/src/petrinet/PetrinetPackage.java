...
public interface PetrinetPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PLACE__NB_JETONS = NODE_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link petrinet.PetriNet#getNode <em>Node</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Node</em>'.
	 * @see petrinet.PetriNet#getNode()
	 * @see #getPetriNet()
	 * @generated
	 */
	EReference getPetriNet_Node();
	...
	/**
	 * Returns the meta object for the attribute '{@link petrinet.Arc#isReadArc <em>Read Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Read Arc</em>'.
	 * @see petrinet.Arc#isReadArc()
	 * @see #getArc()
	 * @generated
	 */
	EAttribute getArc_ReadArc();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference PETRI_NET__NODE = eINSTANCE.getPetriNet_Node();
		 ...
		 * @generated
		 */
		EAttribute ARC__READ_ARC = eINSTANCE.getArc_ReadArc();
