...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 * @generated
	 */
	public EReference getPetriNet_Node() {
	 ...
	 * @generated
	 */
	public EAttribute getArc_ReadArc() {
	...
	public void createPackageContents() {
		...
		createEReference(petriNetEClass, PETRI_NET__NODE);
		...
		createEAttribute(arcEClass, ARC__READ_ARC);
	...
	public void initializePackageContents() {
		...
		initEReference(getPetriNet_Node(), this.getNode(), null, "node", null, 0, -1, PetriNet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArc_ReadArc(), ecorePackage.getEBoolean(), "readArc", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (arcEClass, 
		   source, 
		   new String[] {
			 "constraints", "sourceTypeDiffTarget positive"
		   });	
		addAnnotation
		  (placeEClass, 
		   source, 
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (arcEClass, 
		   source, 
		   new String[] {
			 "sourceTypeDiffTarget", "self.source.oclType() <> self.target.oclType()",
			 "positive", "self.poids > 0"
		   });	
		addAnnotation
		  (placeEClass, 
		   source, 
		   new String[] {
			 "positive", "self.nbJetons >= 0"
		   });
	}
