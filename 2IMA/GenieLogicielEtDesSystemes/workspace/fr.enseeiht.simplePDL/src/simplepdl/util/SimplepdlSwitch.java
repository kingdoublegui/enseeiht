...
public class SimplepdlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SimplepdlPackage.RESSOURCE_SEQUENCE: {
				RessourceSequence ressourceSequence = (RessourceSequence)theEObject;
				T result = caseRessourceSequence(ressourceSequence);
				if (result == null) result = caseProcessElement(ressourceSequence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Ressource Sequence</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Ressource Sequence</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRessourceSequence(RessourceSequence object) {
		return null;
	}
