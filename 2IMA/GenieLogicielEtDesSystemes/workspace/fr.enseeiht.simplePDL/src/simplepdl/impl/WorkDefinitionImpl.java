 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getRessourcesequence <em>Ressourcesequence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getRessourcesequence() <em>Ressourcesequence</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<RessourceSequence> ressourcesequence;
	 ...
	 * @generated
	 */
	public EList<RessourceSequence> getRessourcesequence() {
		if (ressourcesequence == null) {
			ressourcesequence = new EObjectWithInverseResolvingEList<RessourceSequence>(RessourceSequence.class, this, SimplepdlPackage.WORK_DEFINITION__RESSOURCESEQUENCE, SimplepdlPackage.RESSOURCE_SEQUENCE__WORKDEFINITION);
		}
		return ressourcesequence;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCESEQUENCE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRessourcesequence()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCESEQUENCE:
				return ((InternalEList<?>)getRessourcesequence()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCESEQUENCE:
				getRessourcesequence().clear();
				getRessourcesequence().addAll((Collection<? extends RessourceSequence>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCESEQUENCE:
				return ressourcesequence != null && !ressourcesequence.isEmpty();
		}
