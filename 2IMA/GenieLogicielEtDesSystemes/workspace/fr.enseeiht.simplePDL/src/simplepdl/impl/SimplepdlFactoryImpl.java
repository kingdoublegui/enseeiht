...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESSOURCE_SEQUENCE: return createRessourceSequence();
			default:
	 ...
	 * @generated
	 */
	public RessourceSequence createRessourceSequence() {
		RessourceSequenceImpl ressourceSequence = new RessourceSequenceImpl();
