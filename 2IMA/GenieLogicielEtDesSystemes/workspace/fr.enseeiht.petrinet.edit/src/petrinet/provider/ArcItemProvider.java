	...
	protected void addReadArcPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_readArc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_readArc_feature", "_UI_Arc_type"),
				 PetrinetPackage.Literals.ARC__READ_ARC,
				 true,
				 false,
				 false,
