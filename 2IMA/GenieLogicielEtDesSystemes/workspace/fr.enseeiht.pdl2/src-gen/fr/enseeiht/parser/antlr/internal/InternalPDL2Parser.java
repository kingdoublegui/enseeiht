...
public class InternalPDL2Parser extends AbstractInternalAntlrParser {
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"fr.enseeiht.PDL2.ProcessElement");
                    	...
                    	case 1 :
                    	    ...
                    	    state._fsp--;
                    	    						...
                    	    						add(
                    	    							...
                    	    							"fr.enseeiht.PDL2.DependanceStart");
                    	    						afterParserOrEnumRuleCall();
                    	...
                    	case 1 :
                    	    ...
                    	    state._fsp--;
                    	    						...
                    	    						add(
                    	    							...
                    	    							"fr.enseeiht.PDL2.DependanceFinish");
                    	    						afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"link",
            						lv_link_1_0,
            						"fr.enseeiht.PDL2.WorkSequenceKindStart");
            					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"link",
            						lv_link_1_0,
            						"fr.enseeiht.PDL2.WorkSequenceKindFinish");
            					afterParserOrEnumRuleCall();
    ...
    // InternalPDL2.g:480:1: ruleGuidance returns [EObject current=null] : ( (lv_text_0_0= RULE_STRING ) ) ;
    public final EObject ruleGuidance() throws RecognitionException {
        ...
        try {
            // InternalPDL2.g:486:2: ( ( (lv_text_0_0= RULE_STRING ) ) )
            // InternalPDL2.g:487:2: ( (lv_text_0_0= RULE_STRING ) )
            {
            // InternalPDL2.g:487:2: ( (lv_text_0_0= RULE_STRING ) )
            // InternalPDL2.g:488:3: (lv_text_0_0= RULE_STRING )
            {
            // InternalPDL2.g:488:3: (lv_text_0_0= RULE_STRING )
            // InternalPDL2.g:489:4: lv_text_0_0= RULE_STRING
            {
