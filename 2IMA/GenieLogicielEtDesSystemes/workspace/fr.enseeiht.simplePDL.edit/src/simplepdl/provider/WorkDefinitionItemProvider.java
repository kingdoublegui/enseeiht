...
public class WorkDefinitionItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRessourcesequencePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Ressourcesequence feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRessourcesequencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_ressourcesequence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_ressourcesequence_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__RESSOURCESEQUENCE,
				 true,
				 false,
				 true,
				 null,
