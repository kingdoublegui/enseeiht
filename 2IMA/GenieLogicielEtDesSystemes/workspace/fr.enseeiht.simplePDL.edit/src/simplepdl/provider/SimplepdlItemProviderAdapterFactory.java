...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.RessourceSequence} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected RessourceSequenceItemProvider ressourceSequenceItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.RessourceSequence}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createRessourceSequenceAdapter() {
		if (ressourceSequenceItemProvider == null) {
			ressourceSequenceItemProvider = new RessourceSequenceItemProvider(this);
		}

		return ressourceSequenceItemProvider;
	}
	...
	public void dispose() {
		...
		if (ressourceSequenceItemProvider != null) ressourceSequenceItemProvider.dispose();
	}
