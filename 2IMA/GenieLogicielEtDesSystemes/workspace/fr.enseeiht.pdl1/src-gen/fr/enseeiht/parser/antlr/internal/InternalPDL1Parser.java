...
public class InternalPDL1Parser extends AbstractInternalAntlrParser {
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"fr.enseeiht.PDL1.ProcessElement");
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"linkType",
            						lv_linkType_1_0,
            						"fr.enseeiht.PDL1.WorkSequenceType");
            					afterParserOrEnumRuleCall();
    ...
    // InternalPDL1.g:302:1: ruleGuidance returns [EObject current=null] : ( (lv_text_0_0= RULE_STRING ) ) ;
    public final EObject ruleGuidance() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:308:2: ( ( (lv_text_0_0= RULE_STRING ) ) )
            // InternalPDL1.g:309:2: ( (lv_text_0_0= RULE_STRING ) )
            {
            // InternalPDL1.g:309:2: ( (lv_text_0_0= RULE_STRING ) )
            // InternalPDL1.g:310:3: (lv_text_0_0= RULE_STRING )
            {
            // InternalPDL1.g:310:3: (lv_text_0_0= RULE_STRING )
            // InternalPDL1.g:311:4: lv_text_0_0= RULE_STRING
            {
    ...
    // InternalPDL1.g:330:1: ruleWorkSequenceType returns [Enumerator current=null] : ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) ) ;
    public final Enumerator ruleWorkSequenceType() throws RecognitionException {
        ...
        try {
            // InternalPDL1.g:336:2: ( ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) ) )
            // InternalPDL1.g:337:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) )
            {
            // InternalPDL1.g:337:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) )
            int alt3=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt3) {
                case 1 :
                    // InternalPDL1.g:338:3: (enumLiteral_0= 's2s' )
                    {
                    // InternalPDL1.g:338:3: (enumLiteral_0= 's2s' )
                    // InternalPDL1.g:339:4: enumLiteral_0= 's2s'
                    {
                    ...
                    break;
                case 2 :
                    // InternalPDL1.g:346:3: (enumLiteral_1= 'f2s' )
                    {
                    // InternalPDL1.g:346:3: (enumLiteral_1= 'f2s' )
                    // InternalPDL1.g:347:4: enumLiteral_1= 'f2s'
                    {
                    ...
                    break;
                case 3 :
                    // InternalPDL1.g:354:3: (enumLiteral_2= 's2f' )
                    {
                    // InternalPDL1.g:354:3: (enumLiteral_2= 's2f' )
                    // InternalPDL1.g:355:4: enumLiteral_2= 's2f'
                    {
                    ...
                    break;
                case 4 :
                    // InternalPDL1.g:362:3: (enumLiteral_3= 'f2f' )
                    {
                    // InternalPDL1.g:362:3: (enumLiteral_3= 'f2f' )
                    // InternalPDL1.g:363:4: enumLiteral_3= 'f2f'
                    {
    ...
    public static final BitSet FOLLOW_5 = new BitSet(new long[]{0x000000000000E020L});
